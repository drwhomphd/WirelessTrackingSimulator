...
#FEATURES = ['expected.detected.walk.length']

FOLDER_PREFIX = '/home/nhusted/research/samyers/Wireless-Tracking/Results/conglom/Chicago-Udel-9Blk-9056Peds-0Cars-700to730'
    ...
    for feature in FEATURES:
        ...
        for rad in RADIUS:
		    ...
		    # End if
                    ...
                    output.writelines("%s\t%s\t%s\n" % (lineSplit[targetField], percent, rad))
                # End for
