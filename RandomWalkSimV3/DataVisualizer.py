...
<kml xmlns="http://www.opengis.net/kml/2.2">
  <Document>
    ...
    for person in personTable.iterkeys():
        ...
        <Placemark>
          <name>%s</name>
          <description>Line tracing the brownian random walk</description>
...
def loadAnalysisFile(inFile):
    ...
    for line in input.readlines():
        ...
        if splitLine[0] not in personTable:
            personTable[splitLine[0]] = { splitLine[5] : splitLine[2] + "," + splitLine[3] }
        else:
            personTable[splitLine[0]][splitLine[5]] = splitLine[2] + "," + splitLine[3]
    # End
