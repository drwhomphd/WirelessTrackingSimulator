...
% rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/9056-700-730/1-5perc/routers/3d-histo-percent.steps.detected.outer-15MRad.dat');
% 
...
% 
% rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/9056-700-730/1-5perc/routers/3d-histo-percent.steps.detected.inner-15MRad.dat');
% 
% % The Y Coordinate is the percentage of the population that is detected
% % The X Coordinate is the radius
% % Each line is the percentage of steps detect
...
rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/9056-700-730/1-5perc/cells/3d-histo-percent.steps.detected.outer-15MRad.dat');
...
rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/9056-700-730/1-5perc/cells/3d-histo-percent.steps.detected.inner-15MRad.dat');
...
%legend('> 20% of the time', '> 50% of the time', '> 70% of the time', '> 90% of the time', 'Location', 'Best');
%legend('>10% of the time','>20% of the time', '>30% of the time', '>40% of the time', '>50% of the time', '>60% of the time', '>70% of the time', '>80% of the time', '>90% of the time', 'Location', 'NorthWest')
saveas(gcf, 'udel-9056-700to730-cells-DetectionWith15MRouterRad.pdf', 'pdf')

% %% Outer Both Detections
% 
% rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/9056-700-730/1-5perc/both/3d-histo-percent.steps.detected.outer-15MRad.dat');
% 
% % The Y Coordinate is the percentage of the population that is detected
% % The X Coordinate is the radius
% % Each line is the percentage of steps detect
...
% 
% rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/9056-700-730/1-5perc/both/3d-histo-percent.steps.detected.inner-15MRad.dat');
% 
% % The Y Coordinate is the percentage of the population that is detected
% % The X Coordinate is the radius
% % Each line is the percentage of steps detect
