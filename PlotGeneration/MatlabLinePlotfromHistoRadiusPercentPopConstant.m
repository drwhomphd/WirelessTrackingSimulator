...
% rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/1Perc-15MRad-4000/routers/3d-histo-percent.steps.detected.outer-15MRad.dat');
% rad = sortrows(rad,3);
...
% %title('Change in detections for 4000 Population, 15M Radius, 1% Detectors')
...
% rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/1Perc-15MRad-4000/routers/3d-histo-percent.steps.detected.inner-15MRad.dat');
% rad = sortrows(rad,3);
% % The Y Coordinate is the percentage of the population that is detected
% % The X Coordinate is the radius
% % Each line is the percentage of steps detect
...
% 
% %legend('>10% of the time','>20% of the time', '>30% of the time', '>40% of the time', '>50% of the time', '>60% of the time', '>70% of the time', '>80% of the time', '>90% of the time', 'Location', 'NorthWest')
% saveas(gcf, 'udel-4000Peds-router-Detection15MRouter1PercVarTime.pdf', 'pdf')

%% Outer Cell Detections
%rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/10Perc-15Mrad-9056-FIXED/3d-histo-percent.steps.detected.outer-15MRad.dat');
rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/1Perc-45MRad-9056-Chicago/3d-histo-percent.steps.detected.outer-45MRad.dat');
%rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/dallas-5Perc-15MRad-2988/cells/3d-histo-percent.steps.detected.outer-15MRad.dat');
rad = sortrows(rad,3);
% The Y Coordinate is the percentage of the population that is detected
% The X Coordinate is the radius
% Each line is the percentage of steps detect
...
rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/1Perc-45MRad-2988-Dallas/3d-histo-percent.steps.detected.outer-45MRad.dat');
%rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/dallas-10Perc-15MRad-FIXED/3d-histo-percent.steps.detected.inner-15MRad.dat');
%rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/dallas-5Perc-15MRad-2988/cells/3d-histo-percent.steps.detected.inner-15MRad.dat');
rad = sortrows(rad,3);
% The Y Coordinate is the percentage of the population that is detected
% The X Coordinate is the radius
% Each line is the percentage of steps detect
...
%plot(x, y3, 'b.-', x, y6, 'kx-.', x, y8, 'cs-', x, y10, 'r+--','Linewidth', 3);
%plot(x, y3, 'b.-', x, yi3, 'b<-', x, y6, 'kx-.', x, yi6, 'k>-.', x, y10, 'r+--', x, yi10, 'ro-','Linewidth', 3);
plot(x, y2, 'g+--', x, yi2, 'go-', x, y3, 'b.:', x, yi3, 'bp-', x, y6, 'kx-.', x, yi6, 'k>-', x, y10, 'r+--', x, yi10, 'ro-','Linewidth', 3);
%plot(x, y2, 'g+--', x, y3, 'b--', x, y6, 'kx-.', x, y10, 'r+--', 'Linewidth', 3);
title('Change in detections for Chicago and Dallas, 45 Meter Radius, 1% Detectors')
xlabel('Time of Day (h)')
ylabel('Fraction of Population Detected')
ylim([0 1])
set(gca,'XTick', x)
...
%legend('> 20% of the time', '> 50% of the time', '> 70% of the time', '> 90% of the time', 'Location', 'Best');
%legend('>10% of the time','>20% of the time', '>30% of the time', '>40% of the time', '>50% of the time', '>60% of the time', '>70% of the time', '>80% of the time', '>90% of the time', 'Location', 'NorthWest')
%legend('> 10% of the time(outer)', '> 20% of the time(outer)','> 50% of the time(outer)', '> 90% of the time(outer)','Location', 'NorthEast'); 
saveas(gcf, 'chicago-dallas-udel-cells-Detection45MRouter1PercVarTime.pdf', 'pdf')

% %% Outer Both Detections
% 
% rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/1Perc-15MRad-4000/both/3d-histo-percent.steps.detected.outer-15MRad.dat');
% rad = sortrows(rad,3);
% % The Y Coordinate is the percentage of the population that is detected
% % The X Coordinate is the radius
% % Each line is the percentage of steps detect
...
% 
% rad = load('/home/nhusted/research/samyers/Wireless-Tracking/Statistics/udel-statistics/1Perc-15MRad-4000/both/3d-histo-percent.steps.detected.inner-15MRad.dat');
% rad = sortrows(rad,3);
% % The Y Coordinate is the percentage of the population that is detected
% % The X Coordinate is the radius
% % Each line is the percentage of steps detect
...
% %%legend('> 20% of the time', '> 50% of the time', '> 70% of the time', '> 90% of the time', 'Location', 'Best');
% %legend('>10% of the time','>20% of the time', '>30% of the time', '>40% of the time', '>50% of the time', '>60% of the time', '>70% of the time', '>80% of the time', '>90% of the time', 'Location', 'NorthWest')
% saveas(gcf, 'udel-4000Peds-both-Detection15MRouter1PercVarTime.pdf', 'pdf')
